...
use settings::{
    DockSide, FolderIndicator, IntoGpui, ProjectPanelEntrySpacing, ProjectPanelSortDirection,
    ProjectPanelSortMode, ProjectPanelSortOrder, ProjectPanelTitleTooltipDelay, RegisterSetting,
